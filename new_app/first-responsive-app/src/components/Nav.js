                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="rs-demo-premium-concept.html">
                                                    <div>
                                                        Premium Templates
                                                    </div>
                                                </a>
                            ...
                            <li>
                                <a href="#">
                                    <div>
                                        <i className="icon-align-justify2" />
                                        Menu Styles
                                    </div>
                                </a>
                                <ul>
                            ...
                            <ul className="mega-menu-column col-5">
                                ...
                                <li>
                                    <a href="component-radios-switches.html">
                                        <div>
                                            <i className="icon-line-square-check" />
                                            Radios &amp; Switches
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="component-typeahead.html">
                                        <div>
